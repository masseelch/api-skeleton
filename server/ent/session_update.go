...
func (su *SessionUpdate) SetIdleTimeExpiredAt(t time.Time) *SessionUpdate {
	su.mutation.SetIdleTimeExpiredAt(t)
	return su
}
...
func (su *SessionUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := su.mutation.IdleTimeExpiredAt(); ok {
...
// SetIdleTimeExpiredAt sets the idleTimeExpiredAt field.
func (suo *SessionUpdateOne) SetIdleTimeExpiredAt(t time.Time) *SessionUpdateOne {
	suo.mutation.SetIdleTimeExpiredAt(t)
	return suo
}
...
func (suo *SessionUpdateOne) sqlSave(ctx context.Context) (_node *Session, err error) {
	...
	if value, ok := suo.mutation.IdleTimeExpiredAt(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
			Column: session.FieldIdleTimeExpiredAt,
