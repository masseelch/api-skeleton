...
// OldColor returns the old color value of the Tag.
// If the Tag object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
...
func (m *TransactionMutation) SetAmount(s server.Money) {
	m.amount = &s
	m.addamount = nil
}

// Amount returns the amount value in the mutation.
func (m *TransactionMutation) Amount() (r server.Money, exists bool) {
	v := m.amount
	if v == nil {
		return
	}
...
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *TransactionMutation) OldAmount(ctx context.Context) (v server.Money, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *TransactionMutation) AddAmount(s server.Money) {
	if m.addamount != nil {
		*m.addamount += s
	} else {
		m.addamount = &s
...
func (m *TransactionMutation) AddedAmount() (r server.Money, exists bool) {
	v := m.addamount
	if v == nil {
		return
	}
...
// OldTitle returns the old title value of the Transaction.
// If the Transaction object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
...
// ClearAccount clears the account edge to Account.
func (m *TransactionMutation) ClearAccount() {
	m.clearedaccount = true
}

// AccountCleared returns if the edge account was cleared.
func (m *TransactionMutation) AccountCleared() bool {
	return m.clearedaccount
}

// AccountID returns the account id in the mutation.
...
// AccountIDs returns the account ids in the mutation.
// Note that ids always returns len(ids) <= 1 for unique edges, and you should use
...
// ResetAccount reset all changes of the "account" edge.
