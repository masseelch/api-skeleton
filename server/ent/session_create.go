...
func (sc *SessionCreate) SetIdleTimeExpiredAt(t time.Time) *SessionCreate {
	sc.mutation.SetIdleTimeExpiredAt(t)
	return sc
}

// SetLifeTimeExpiredAt sets the lifeTimeExpiredAt field.
func (sc *SessionCreate) SetLifeTimeExpiredAt(t time.Time) *SessionCreate {
	sc.mutation.SetLifeTimeExpiredAt(t)
	return sc
}
...
func (sc *SessionCreate) check() error {
	if _, ok := sc.mutation.IdleTimeExpiredAt(); !ok {
		return &ValidationError{Name: "idleTimeExpiredAt", err: errors.New("ent: missing required field \"idleTimeExpiredAt\"")}
	}
	if _, ok := sc.mutation.LifeTimeExpiredAt(); !ok {
		return &ValidationError{Name: "lifeTimeExpiredAt", err: errors.New("ent: missing required field \"lifeTimeExpiredAt\"")}
	}
	return nil
}
...
func (sc *SessionCreate) createSpec() (*Session, *sqlgraph.CreateSpec) {
	...
	if value, ok := sc.mutation.IdleTimeExpiredAt(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
			Column: session.FieldIdleTimeExpiredAt,
		})
		_node.IdleTimeExpiredAt = value
	}
	if value, ok := sc.mutation.LifeTimeExpiredAt(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
			Column: session.FieldLifeTimeExpiredAt,
		})
		_node.LifeTimeExpiredAt = value
	}
